#==============================================================================#
#                            CorpusSourceQuanteda                              #
#==============================================================================#
#' CorpusSourceQuanteda
#'
#' \code{CorpusSourceQuanteda} Creates Corpus objects from Quanteda corpus objects.
#'
#' @template corpusSourceStrategyClasses
#'
#' @section CorpusSourceQuanteda Methods:
...
#' @export
CorpusSourceQuanteda <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(name, dataSource) {
      ...
      private$..className <- 'CorpusSourceQuanteda'
