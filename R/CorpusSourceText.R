...
#' CorpusSourceText
#'
#' \code{CorpusSourceText} Creates Corpus objects from text sources
#'
#' @template corpusSourceStrategyClasses
#'
#' @section CorpusSourceText Methods:
...
CorpusSourceText <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(name, dataSource, flat = FALSE) {
      ...
      private$..className <- 'CorpusSourceText'
