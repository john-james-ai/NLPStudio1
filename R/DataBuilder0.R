...
#' DataBuilder0
#'
#' \code{DataBuilder0} Abstract class for building the corpus data
#'
...
CorpusBuilder0 <- R6::R6Class(
  ...
  public = list(
    ...
    #                             Core Methods                                #
    #-------------------------------------------------------------------------#
    initialize = function(name, desc = NULL) stop("This method is not implemented in this abstract class."),
    sourceData = function(url) stop("This method is not implemented in this abstract class."),
    refine = function() stop("This method is not implemented in this abstract class."),
    buildCV = function(train, val, test) stop("This method is not implemented in this abstract class."),
    buildCVKFold = function(k) stop("This method is not implemented in this abstract class."),
    parse = function(...) stop("This method is not implemented in this abstract class."),
    normalize = function(norms) stop("This method is not implemented in this abstract class."),
    filterWord = function(stopWords) stop("This method is not implemented in this abstract class."),
    filterSent = function(stopWords) stop("This method is not implemented in this abstract class."),
    filterTag = function(stopWords, tag) stop("This method is not implemented in this abstract class."),
    commit = function() stop("This method is not implemented in this abstract class.")
  )
)
