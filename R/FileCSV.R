...
#' FileCSV
#'
#' \code{FileCSV} Class containing the methods for reading, writing and repairing CSV files.
#'
#' Class contains methods for reading, writing and repairing CSV files containing text content.
#'
#' @section FileCSV core methods:
#'  \itemize{
...
#'  }
#'
#' @section FileCSV getter/setter methods:
#'  \itemize{
#'   \item{\code{desc()}}{Method for setting or retrieving the FileCSV object description.}
#'  }
#'
#'  @section FileCSV IO methods:
#'  \itemize{
...
#'  }
#'
#' @section FileCSV aggregation method:
#'  \itemize{
...
FileCSV <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(name, path) {
      ...
      private$..className <- 'FileCSV'
      private$..methodName <- 'initialize'
      private$..name <- name
      private$..path <- path
      private$..content <- NULL
      private$..state <- paste0("FileCSV, ", private$..name, ", instantiated at", Sys.time())
