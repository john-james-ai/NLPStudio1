...
#' FileRDS
#'
#' \code{FileRDS} Class containing the methods for reading, writing and repairing RDS files.
#'
#' Class contains methods for reading, writing and repairing RDS files containing text content.
#'
#' @section FileRDS core methods:
#'  \itemize{
...
#'  }
#'
#' @section FileRDS getter/setter methods:
#'  \itemize{
#'   \item{\code{desc()}}{Method for setting or retrieving the FileRDS object description.}
#'  }
#'
#'  @section FileRDS IO methods:
#'  \itemize{
...
#'  }
#'
#' @section FileRDS aggregation method:
#'  \itemize{
...
FileRDS <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(name, path) {
      ...
      private$..className <- 'FileRDS'
      private$..methodName <- 'initialize'
      private$..name <- name
      private$..path <- path
      private$..content <- NULL
      private$..state <- paste0("FileRDS, ", private$..name, ", instantiated at", Sys.time())
