...
#' FileTXT
#'
#' \code{FileTXT} Class containing the methods for reading, writing and repairing text files.
#'
#' Class contains methods for reading, writing and repairing text files.
#'
#' @section FileTXT core methods:
#'  \itemize{
...
#'  }
#'
#' @section FileTXT getter/setter methods:
#'  \itemize{
#'   \item{\code{desc()}}{Method for setting or retrieving the FileTXT object description.}
#'  }
#'
#'  @section FileTXT IO methods:
#'  \itemize{
...
#'  }
#'
#' @section FileTXT aggregation method:
#'  \itemize{
...
FileTXT <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(name, path) {
      ...
      private$..className <- 'FileTXT'
      private$..methodName <- 'initialize'
      private$..name <- name
      private$..path <- path
      private$..content <- NULL
      private$..state <- paste0("FileTXT, ", private$..name, ", instantiated at", Sys.time())
