...
#' ParseControlCmd
#'
#' \code{ParseControlCmd} Concrete command class responsible for executing the email parse command.
#'
...
#'  }
#'
#' @section ParseControlCmd methods:
#'  \itemize{
...
#' @export
ParseControlCmd <- R6::R6Class(
  classname = "ParseControlCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
