...
#' ParseDigitCmd
#'
#' \code{ParseDigitCmd} Concrete command class responsible for executing the email parse command.
#'
...
#' @export
ParseDigitCmd <- R6::R6Class(
  classname = "ParseDigitCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
