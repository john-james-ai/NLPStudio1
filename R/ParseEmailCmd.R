...
#' ParseEmailCmd
#'
#' \code{ParseEmailCmd} Concrete command class responsible for executing the email parse command.
#'
...
#' @export
ParseEmailCmd <- R6::R6Class(
  classname = "ParseEmailCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
