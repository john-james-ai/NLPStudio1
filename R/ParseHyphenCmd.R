...
#' ParseHyphenCmd
#'
#' \code{ParseHyphenCmd} Concrete command class responsible for executing the email parse command.
#'
...
#'  }
#'
#' @section ParseHyphenCmd methods:
#'  \itemize{
...
#' @export
ParseHyphenCmd <- R6::R6Class(
  classname = "ParseHyphenCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
