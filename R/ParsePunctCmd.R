...
#' ParsePunctCmd
#'
#' \code{ParsePunctCmd} Concrete command class responsible for executing the email parse command.
#'
...
#' @export
ParsePunctCmd <- R6::R6Class(
  classname = "ParsePunctCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
