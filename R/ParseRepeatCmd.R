...
#' ParseRepeatCmd
#'
#' \code{ParseRepeatCmd} Concrete command class responsible for executing the email parse command.
#'
...
#'  }
#'
#' @section ParseRepeatCmd methods:
#'  \itemize{
...
#' @export
ParseRepeatCmd <- R6::R6Class(
  classname = "ParseRepeatCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
