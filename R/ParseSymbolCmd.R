...
#' ParseSymbolCmd
#'
#' \code{ParseSymbolCmd} Concrete command class responsible for executing the email parse command.
#'
...
#'  }
#'
#' @section ParseSymbolCmd methods:
#'  \itemize{
...
#' @export
ParseSymbolCmd <- R6::R6Class(
  classname = "ParseSymbolCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
