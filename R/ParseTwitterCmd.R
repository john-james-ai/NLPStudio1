...
#' ParseTwitterCmd
#'
#' \code{ParseTwitterCmd} Concrete command class responsible for executing the email parse command.
#'
...
#'  }
#'
#' @section ParseTwitterCmd methods:
#'  \itemize{
...
#' @export
ParseTwitterCmd <- R6::R6Class(
  classname = "ParseTwitterCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
