...
#' ParseUrlCmd
#'
#' \code{ParseUrlCmd} Concrete command class responsible for executing the URL parse command.
#'
...
#' @export
ParseUrlCmd <- R6::R6Class(
  classname = "ParseUrlCmd",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Command0,
