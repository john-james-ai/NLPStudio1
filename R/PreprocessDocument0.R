...
#' PreprocessDocument0
#'
#' \code{PreprocessDocument0} Abstract superclass that defines the methods common to all Document Process family classes.
#'
...
#' @export
PreprocessDocument0 <- R6::R6Class(
  classname = "PreprocessDocument0",
  lock_objects = FALSE,
  lock_class = FALSE,
  inherit = Process0,
  ...
  public = list(
    ...
    accept = function(visitor)  {
      visitor$preprocessDocument0(self)
    }
  )
)
