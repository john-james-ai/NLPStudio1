#==============================================================================#
#                       PreprocessDocumentEncoding                             #
#==============================================================================#
#' PreprocessDocumentEncoding
#'
#' \code{PreprocessDocumentEncoding} Class responsible for performing encoding repairs in Document objects.
#'
...
#' @export
PreprocessDocumentEncoding <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(object, name, substitutions = NULL) {
      ...
      private$..className <- "PreprocessDocumentEncoding"
      ...
      # log
      private$..state <- paste0("Successfully initialized PreprocessDocumentEncoding class object.")
      self$logIt()
    ...
    preprocess = function() {
      ...
      # log
      private$..state <- paste0("Successfully performed PreprocessDocumentEncoding.")
      self$logIt()
    ...
    accept = function(visitor)  {
      visitor$processDocumentEncoding(self)
    }
  )
)
