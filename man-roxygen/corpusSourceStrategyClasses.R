#' @section CorpusSource Family of Classes Introduction:
#' The CorpusSource family of classes is an implementation of the
...
#'  \item CorpusSourceDir: Class creates a Corpus object from files contained a designated directory .
#'  \item CorpusJSON: Class creates a Corpus object from a JSON source.
#'  \item CorpusSourceText: Class creates Corpus objects from text sources.
#'  \item CorpusXML: Class creates a Corpus object from an XML source.
#'  \item CorpusSourceQuanteda: Class creates a Corpus object from an Quanteda corpus object.
