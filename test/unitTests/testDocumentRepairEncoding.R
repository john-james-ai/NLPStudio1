testDocumentRepairEncoding <- function() {
  ...
  init <- function() {
    ...
    RepairDocumentEncodingTest <<- LogTest$new()
  }
  ...
  test0 <- function() {
    ...
    # Logit
    RepairDocumentEncodingTest$logs(className = className, methodName = "initialize", msg = paste("Successfully initialized document"))
  ...
  test1 <- function(news) {
    ...
    news2 <- ProcessDocumentRepairEncoding$new(news, "news2")$process()$getResult()
    ...
    # Logit
    RepairDocumentEncodingTest$logs(className = className, methodName = "process", msg = paste("Successfully processed repair"))
    RepairDocumentEncodingTest$logs(className = className, methodName = "process", msg = paste("Successfully returned repaired object"))
  ...
  test2 <- function(news) {
    ...
    news3 <- ProcessDocumentRepairEncoding$new(news2, "news3", substitutions = subs)$process()$getResult()
  ...
  testn <- function(news) {
    ...
    # Logit
    RepairDocumentEncodingTest$logs(className = className, methodName = "content", msg = paste("Successfully instantiated document with file"))
