testPreprocessDocumentBin <- function() {
  ...
  test0 <- function() {
    ...
    # Logit
    PreprocessDocumentBinTest$logs(className = className, methodName = "initialize", msg = paste("Successfully initialized document"))
  ...
  testn <- function(news) {
    ...
    # Logit
    PreprocessDocumentBinTest$logs(className = className, methodName = "content", msg = paste("Successfully instantiated document with file"))
